...
class TP11g(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TP11g")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/mateo/Desktop/Link to UCA/Radiodifusion/Ejercicios/TP1GNU/TP1-1g-datos.bin', False)
...
def main(top_block_cls=TP11g, options=None):
