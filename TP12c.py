...
class TP12c(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TP12c")
        ...
        labels = ['Señal Modulada', 'Señal Demodulada', 'Signal 3', 'Signal 4', 'Signal 5',
...
def main(top_block_cls=TP12c, options=None):
