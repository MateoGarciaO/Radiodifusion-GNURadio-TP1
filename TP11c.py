...
class TP11c(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TP11c")
        ...
        self.Frecuencia = Frecuencia = 1e3
        ...
        self._Frecuencia_range = Range(0, samp_rate/2, 10, 1e3, 200)
        self._Frecuencia_win = RangeWidget(self._Frecuencia_range, self.set_Frecuencia, "Fracuencia", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Frecuencia_win)
        self._Amplitud_range = Range(0, 100, 1, 1, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, Frecuencia, Amplitud, 0, 0)
...
def main(top_block_cls=TP11c, options=None):
