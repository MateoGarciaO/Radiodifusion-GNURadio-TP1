...
class TP12b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TP12b")
        ...
        labels = ['Modulada', 'Demodulada', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.qtgui_freq_sink_x_0, 1))
...
def main(top_block_cls=TP12b, options=None):
